...
global a h k  Va k_s W psi_w A_w A_phiw epsilon nabla zeta_0 zeta_1 zeta_2 c0 c1 c2 c3 ...
...
[t,x] = ode45(@(t,x)fun_parabola(t,x,u,v,Time) ,tspan, x_initial,options);
x_ini = x(1,1) ;
y_ini = x(1,2) ;
x_end = x(end,1) ;
y_end = x(end,2) ;
...
% Plot format control variables
    lw = 3;             % Line width
    ms = 6;             % Marker size
    ax_fnt = 20;        % Axis font size
    lbl_fnt = 23; % Label font size
...
function out = fun_parabola(t,x,u,v,Time)
global Va a h k W psi_w A_w A_phiw c0 c2 c1 epsilon tez uz zeta_1 zeta_2 sz k_s Va wxs wys nabla kai_ddot
