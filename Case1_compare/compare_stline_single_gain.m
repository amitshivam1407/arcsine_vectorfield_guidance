...
% xl = xline(ax1,0,'--k','linewidth',2);hold(ax1,'on'); grid(ax1,'on'); 
% h11 = plot(ax1,x(:,1),x(:,2),'r','linewidth',2);hold(ax1,'on'); 
% h21 = plot(ax1,x(:,5),x(:,6),'b','linewidth',2);hold(ax1,'on'); 
...
% xlabel(ax1,' $$ x, $$  m','Fontsize',lbl_fnt);
% ylabel(ax1,'$ y, $ m','Fontsize',lbl_fnt);
% legend(ax1,'Desired path','Proposed','Nelson et al. 2007','Fontsize',lgd_fnt);
% l = legend(ax1,[xl h11 h21],'Desired path','Proposed','Nelson et al.','Fontsize',lgd_fnt);hold on;
% axis(ax1, 'equal');
% box(ax1,'on')
% 
% f2;
