...
h12 = plot(X(1,:),X(2,:),'--','color',red,'LineWidth',3,'DisplayName','Variable $$L_0$$') ;hold on;grid on;
% else
...
figure(2)
h2 = plot(tout,d_v,'--','color',red,'LineWidth',3,'DisplayName','Variable $$L_0$$') ;hold on;grid on;
ax2 = gca;
ax2.FontSize = ax_fnt;
box on                        % Switch on the box around the axis
...
ylabel(ax2,'Cross-track error','Fontsize',lbl_fnt);

figure(3)
h32 = plot(tout,wrapToPi(eta_v)*(180/pi),'--','color',red,'linewidth',3,'DisplayName','Variable $$L_0$$') ;hold on;grid on;
ax3 = gca;
ax3.FontSize = ax_fnt;
box on                        % Switch on the box around the axis
